<template>
  <div class="navigatorContainer">
    ...
    <!-- <div class="item">
      <a href="https://gitee.com/Ning310975876" target="_blank">
...
import { langList } from '@/components/SimpleMindMap/config'
import i18n from '@/components/SimpleMindMap/i18n'
import { storeLang, getLang } from '@/components/SimpleMindMap/api'
